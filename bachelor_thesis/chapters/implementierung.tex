...
Die erforderlichen Grundlagen und \textit{Best Practices} bezüglich asynchroner Programmierung, und im Speziellen der Verwendung von Dataflows, wurden aus dem Fachbuch \citetitle{cleary2019concurrency} von \citeauthor{cleary2019concurrency}, Microsoft-MVP und Experte in asynchroner Programmierung, entnommen.
